...
1. No se puede predecir un partido ya finalizado.
2. El apostador debe existir.
3. El apostador debe estar activo.
4. El partido debe existir.
5. Un apostador no puede tener dos predicciones para el mismo partido.
6. Un partido no se puede finalizar dos veces.
7. Al finalizar un partido, se evalúan automáticamente todas sus predicciones.
...
|---|---|---|
| `.github/workflows/pruebas.yml` | `develop` | ≥ 60% |
| `.github/workflows/produccion.yml` | `main` | ≥ 85% |
...
| Ambiente | Rama | Cobertura mínima |
|---|---|---|
| Pruebas | `develop` | ≥ 60% |
| Producción | `main` | ≥ 85% |
